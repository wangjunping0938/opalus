...
class DesignConf(Base):
    ...
    bd_hot_count_b = db.IntField(default=0)    # 热度量(万) >=1 & < 10
    bd_hot_count_c = db.IntField(default=0)    # 热度量(万) >=10 & < 50
    bd_hot_count_d = db.IntField(default=0)    # 热度量(万) >=50 & < 100
    bd_hot_count_e = db.IntField(default=0)    # 热度量(万) >=100 & < 500
    bd_hot_count_f = db.IntField(default=0)    # 热度量(万) >=500
