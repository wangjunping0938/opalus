...
from app.forms import column_zone
from app.forms import column
...
def column_list():
    ...
    return render_template('admin/column/column_list.html', meta=meta)
...
def column_submit():
    ...
    return render_template('admin/column/column_submit.html', meta=meta, form=form)
...
def column_zone_list():
    ...
    return render_template('admin/column/column_zone_list.html', meta=meta)
...
def column_zone_submit():
    ...
    form = column_zone.SaveForm()

    meta['referer_url'] = request.environ.get('HTTP_REFERER') if request.environ.get('HTTP_REFERER') else ''

    return render_template('admin/column/column_zone_submit.html', meta=meta, form=form)
