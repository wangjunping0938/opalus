...
class SaveForm(FlaskForm):
    ...
    bd_hot_count_b = IntegerField()    # 热度量(万) >=1 & < 10
    bd_hot_count_c = IntegerField()    # 热度量(万) >=10 & < 50
    bd_hot_count_d = IntegerField()    # 热度量(万) >=50 & < 100
    bd_hot_count_e = IntegerField()    # 热度量(万) >=100 & < 500
    bd_hot_count_f = IntegerField()    # 热度量(万) >=500
